...
colors = ['blue', 'black', 'brown', 'organge', 'red']
...
# Problem 12
# Research to find the Python method that allows you to add an element to the end of 
# the array (similar to push() in JavaScript), then add a name to the end of the `friends` array.
...
last_item = len(friends)

friends.pop(last_item)
